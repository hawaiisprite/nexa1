...
pForm.gfnSetMain = function(bInit)
{
	...
	// Layout
	objApp.gvVfrs.set_separatesize("0,80,*");
...
pForm.gfnShowLeftFrame = function ()
{
	...
	typeof objApp.gvFrmMdi.form.btnLeftMenuShowHide === "undefined" ? null : objApp.gvFrmMdi.form.btnLeftMenuShowHide.set_cssclass("btn_MDI_Close");
...
pForm.gfnHideLeftFrame = function ()
{
	...
	//objApp.gvFrmMdi.form.btnLeftMenuShowHide.set_cssclass("btn_MDI_Open");
		typeof objApp.gvFrmMdi.form.btnLeftMenuShowHide === "undefined" ? null : objApp.gvFrmMdi.form.btnLeftMenuShowHide.set_cssclass("btn_MDI_Open");
